...
import { CheckCircle2, ShieldCheck, Shield, Lock, FileText, ChevronDown } from 'lucide-react';
    ...
    <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-end">
      ...
      <div className="bg-surface-container-low rounded-xl p-8 flex flex-col h-full border border-transparent hover:border-outline-variant/20 transition-all duration-300">
        ...
        <Link href="/auth" className="block w-full">
          <button className="w-full py-3 bg-surface-container-high text-on-surface font-bold rounded-xl hover:bg-surface-dim transition-colors">
            Start Trial
          </button>
        </Link>
      </div>
      ...
      <div className="bg-surface-container-low rounded-xl p-8 flex flex-col h-full border border-transparent hover:border-outline-variant/20 transition-all duration-300">
        ...
        <Link href="/contact" className="block w-full">
          <button className="w-full py-3 border-2 border-outline-variant/30 text-on-surface font-bold rounded-xl hover:bg-surface-container-high transition-colors">
            Contact Sales
          </button>
        </Link>
      </div>
