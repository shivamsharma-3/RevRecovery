  ...
  return (
    <div className="min-h-screen bg-surface text-on-surface">
      ...
      <main className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
        ...
        <p>
          RevRecover AI is an early-stage platform that helps healthcare practices triage denied
          insurance claims, draft appeal letters, and estimate patient no-show risk. Claims are
          entered manually or imported from CSV. We reserve the right to modify, suspend, or
          discontinue any part of the Services at any time.
        </p>
        <p>
          <strong>Automated outreach is not part of the Services.</strong> The platform does not
          send SMS or email to your patients, and does not submit claims or appeals to payers on
          your behalf. Anything the platform produces is for you to review and act on yourself.
        </p>

          <h2 className="text-2xl font-bold text-teal-900 mt-12 mb-4 flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-teal-50 text-teal-700 text-sm">3</span>
            AI Output — Your Responsibility to Verify
          </h2>
        <p>
          Recovery probabilities, priorities, denial categories, recommended actions, no-show
          scores, and appeal letters are generated by an automated model. <strong>They are
          estimates, not professional advice</strong>, and they can be wrong.
        </p>
        <ul className="list-disc pl-6 space-y-2 mb-8">
          <li>Nothing the platform outputs constitutes legal, billing, coding, medical, or financial advice.</li>
          <li>A recovery probability is not a prediction that any specific claim will be paid, and no amount of recovered revenue is promised or guaranteed.</li>
          <li>Appeal letters are drafts. They contain bracketed placeholders where clinical detail is required, and you must verify every factual and clinical statement before sending anything to a payer.</li>
          <li>You are responsible for the accuracy of everything you submit to a payer, regardless of whether it originated from this platform.</li>
          <li>Always verify the platform&apos;s assessment against the payer&apos;s remittance advice and your own records before acting on it.</li>
        </ul>
        ...
        <p>
          <strong>We are not a HIPAA Business Associate and do not offer Business Associate
          Agreements.</strong> You must not upload Protected Health Information to the Services.
          The platform is built to operate on de-identified claim data — procedure codes, amounts,
          denial reasons, dates, and payer names.
        </p>
        <p>
          If you choose to enter patient-identifying information despite this, you do so at your own
          risk and remain solely responsible for compliance with HIPAA and any other applicable law.
          Note that claim details you submit for analysis are transmitted to a third-party AI
        ...
        <p>
          ...
          <h2 className="text-2xl font-bold text-teal-900 mt-12 mb-4 flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-teal-50 text-teal-700 text-sm">11</span>
            Contact Information
          </h2>
